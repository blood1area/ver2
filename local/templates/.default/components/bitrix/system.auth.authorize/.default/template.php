...
<div class="bx-auth">
	<div class="bx-auth-note"><?=Loc::getMessage("AUTH_PLEASE_AUTH")?></div>
	...
	<form name="form_auth" method="post" target="_top" action="<?=$arResult["AUTH_URL"]?>">
		...
		<table class="bx-auth-table">
			...
			<?if($arResult["CAPTCHA_CODE"]):?>
				...
				<tr>
					<td class="bx-auth-label"><?echo Loc::getMessage("AUTH_CAPTCHA_PROMT")?>:</td>
...
<?if ($arResult["STORE_PASSWORD"] == "Y"):?>
			<tr>
				<td></td>
				<td><input type="checkbox" id="USER_REMEMBER" name="USER_REMEMBER" value="Y" /><label for="USER_REMEMBER">&nbsp;<?=Loc::getMessage("AUTH_REMEMBER_ME")?></label></td>
			</tr>
<?endif?>
			<tr>
				<td></td>
				<td class="authorize-submit-cell"><input type="submit" name="Login" value="<?=Loc::getMessage("AUTH_AUTHORIZE")?>" /></td>
			</tr>
		</table>
