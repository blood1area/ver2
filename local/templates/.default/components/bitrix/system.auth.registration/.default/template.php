        ...
        <table class="data-table bx-registration-table">
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="password" name="USER_PASSWORD" maxlength="50" value="<?=$arResult["USER_PASSWORD"]?>" class="bx-auth-input" placeholder='<?=PASSWORD_PLACEHOLDER?>' autocomplete="off" /></td>
                </tr>
                <tr>
                    <td><span class="starrequired">*</span><?=GetMessage("AUTH_CONFIRM")?></td>
                    <td><input type="password" name="USER_CONFIRM_PASSWORD" maxlength="50" value="<?=$arResult["USER_CONFIRM_PASSWORD"]?>" class="bx-auth-input" placeholder='<?=PASSWORD_PLACEHOLDER?>' autocomplete="off" /></td>
                </tr>
                <tr>
                    <td><?if($arResult["EMAIL_REQUIRED"]):?><span class="starrequired">*</span><?endif?><?=GetMessage("AUTH_EMAIL")?></td>
                    <td><input type="text" name="USER_EMAIL" maxlength="255" value="<?=$arResult["USER_EMAIL"]?>" placeholder='<?=EMAIL_PLACEHOLDER?>' class="bx-auth-input" /></td>
                </tr>
