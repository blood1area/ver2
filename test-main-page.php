...
?><section class="content">
					...
					<section class="product_line">
						<figure class="product_item">
							<div class="product_item_pict">
								<a href="#">
									<img alt="BMW X3 2.0d" src="local/templates/.default/images/test_top_week_1.png" title="BMW X3 2.0d">
								</a>
							</div>
							<figcaption>
						...
						<figure class="product_item">
							...
							<div class="product_item_pict">
								<a href="#">
									<img alt="AUDI A6 3.0 TFSI" src="local/templates/.default/images/test_top_week_2.png" title="AUDI A6 3.0 TFSI">
								</a>
							</div>
							<figcaption>
						...
						<figure class="product_item">
							...
							<div class="product_item_pict">
								<a href="#">
									<img alt="Mercedes-Benz A200" src="local/templates/.default/images/test_top_week_3.png" title="Mercedes-Benz A200">
								</a>
							</div>
							<figcaption>
						...
						<figure class="product_item">
							<div class="product_item_pict">
								<a href="#">
									<img alt="BMW Z4 sDrive35i" src="local/templates/.default/images/no-image.jpg" title="BMW Z4 sDrive35i">
								</a>
							</div>
							<figcaption>
			...
			<div class="clear"></div><?require($_SERVER["DOCUMENT_ROOT"]."/bitrix/footer.php");?>